...
class PokerTableTest {
	...
	void testSuperpowerAdd() {
		...
		assertEquals(3, player1.getPlayerHand().getHand().size());
		assertEquals(3, player2.getPlayerHand().getHand().size());
		assertEquals(3, player3.getPlayerHand().getHand().size());
		assertEquals(3, player4.getPlayerHand().getHand().size());
	...
	void testSuperpowerAddHidden() {
		...
		assertEquals(3, player3.getPlayerHand().getHand().size());
		assertEquals(3, player4.getPlayerHand().getHand().size());
		assertEquals(2, table.getPlayers().get(4).getPlayerHand().getHand().size());
	...
	void testSuperpowerDestroy() {
		...
		assertEquals(Math.max(0, 2 - map.get(removed1)), removed1.getPlayerHand().getHand().size());
		assertEquals(Math.max(0, 2 - map.get(removed2)), removed2.getPlayerHand().getHand().size());
		assertEquals(Math.max(0, 2 - map.get(removed3)), removed3.getPlayerHand().getHand().size());
		assertEquals(Math.max(0, 2 - map.get(removed4)), removed4.getPlayerHand().getHand().size());
	}
